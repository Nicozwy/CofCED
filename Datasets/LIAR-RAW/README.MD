...
To alleviate the dependency of fact-checked reports, we extended public LIAR dataset with additional raw reports for each claim. Besides, We also and put these raw reports into a sigle file with the format of LIAR. 
